...
export const JobFull = () => {
   ...
   const { t } = useTranslation();
    ...
    let job = jobs.filter((item:any) => {return item.job_id === id})[0]
            ...
            <div className="group bg-gray-900 p-4 transition-all duration-300 hover:rotate-1 lg:p-8">
              ...
              <div className="flex items-center gap-x-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-gray-300">{job.job_city}, {job.job_country}</span>
                </div>
              </div>
              <div className="my-4">
                ...
                <div className="text-sm font-medium">
                  ...
                  <span className="m-1 ml-0 inline-block text-lime-500">{job.job_posted_at_datetime_utc}</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <a className="font-medium text-blue-500 transition-all duration-300 group-hover:text-blue-500/80" href={job.job_apply_link} target="_blank">{t("apply")}</a>
              </div>
            </div>
          </div>
